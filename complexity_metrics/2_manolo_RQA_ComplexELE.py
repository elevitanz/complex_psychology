# misure di complessità sui dati normalizzati dal pc di manolo
import pandas as pd
import numpy as np
import itertools
...
def calcular_complejidad(ts, embedding_dim):
    ...
    try:
        return {
            ...
            "Hurst Exponent": nolds.hurst_rs(ts, fit="poly"),
            "DFA": nolds.dfa(ts),
...
if __name__ == "__main__":
    # file_path = "C:/Users/Usuario/Dropbox/AArticulos en curso/Piero/Eleonora/4_fisher-20250206T125942Z-001/4_fisher/Fisher"
    ...
    folder = 'C:/Users/Usuario/Dropbox/AArticulos en curso/Piero/Eleonora/4_fisher-20250206T125942Z-001/4_fisher/Fisher/'
    ...
    for subfolder in sorted(subfolders):
        if subfolder.startswith('P'):  # Checking for folders that start with 'P'
            ...
            if not subfolder.startswith('P206'):
                ...
                data_bar = data.drop(columns=['Unnamed: 0','Survey.Creation.Date', 'Survey.Completion.Date', 'How.many.hours.did.you.sleep.last.night', 'Experienced.difficulty.falling.or.staying.asleep',
                'Experienced.restless.or.unsatisfying.sleep'])
